...
export const playerTrackUpdate = S.extend(
    S.Struct({
        /**
         * Additional track data to be sent back in the Track Object
         */
        userData: S.optional(S.Record({ key: S.String, value: S.Unknown })),
    }),
    S.Union(
        // `identifier` and `encodedTrack` are exclusive, find out a way to validate that.
        S.Struct({
            /**
