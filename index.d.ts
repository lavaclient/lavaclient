...
declare namespace lavaclient {
  ...
  export class Player extends EventEmitter {
     ...
     * @param op The operation that's being performed.
  ...
  export interface Player {
     ...
     */
    on(event: "playerUpdate", listener: (update: PlayerUpdate) => any): this;
     ...
     */
    on(event: "error", listener: (event: TrackExceptionEvent) => any): this;
